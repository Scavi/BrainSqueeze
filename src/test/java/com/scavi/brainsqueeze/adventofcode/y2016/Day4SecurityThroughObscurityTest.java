...
import com.scavi.brainsqueeze.adventofcode.y2016.Day4SecurityThroughObscurity;
 ...
 * @since 04/12/16
 */
public class Day4SecurityThroughObscurityTest {

    @Test
    public void testValidation1() {
        String[] input = new String[]{"aaaaa-bbb-z-y-x-123[abxyz]", "a-b-c-d-e-f-g-h-987[abcde]",
                                      "not-a-real-room-404[oarel]", "totally-real-room-200[decoy]"};
        Day4SecurityThroughObscurity securityThroughObscurity = new Day4SecurityThroughObscurity();
        int sum = securityThroughObscurity.sectorIdSum(input);
        Assert.assertEquals(1514, sum);
    }


    @Test
    public void testValidation2() {
        String[] input = new String[]{"qzchnzbshud-cxd-trdq-sdrshmf-105[jqexn]"};
        Day4SecurityThroughObscurity securityThroughObscurity = new Day4SecurityThroughObscurity();
        int sum = securityThroughObscurity.sectorIdSum(input);
    ...
    public void testQuestion1() {
        ...
        Day4SecurityThroughObscurity securityThroughObscurity = new Day4SecurityThroughObscurity();
        int sum = securityThroughObscurity.sectorIdSum(input);
        Assert.assertEquals(361724, sum);
    }
    ...
    public void testQuestion2() {
        ...
        Day4SecurityThroughObscurity securityThroughObscurity = new Day4SecurityThroughObscurity();
        int id = securityThroughObscurity.sectorIdLookup(input, "north");
        Assert.assertEquals(482, id);
    }


    private String[] getInput() {
        return new String[]{"aczupnetwp-mfyyj-opalcexpye-977[peyac]",
                            ...
                            "rgndvtcxr-rpcsn-hpath-245[sitjk]", "apuut-xviyt-nzmqdxzn-317[mgons]",
                            ...
                            "pdjqhwlf-gbh-ilqdqflqj-413[qldfh]", "ide-htrgti-snt-hpath-479[thiad]",
                            ...
                            "ftzgxmbv-xzz-wxitkmfxgm-163[xmzfg]", "ujqgywfau-wyy-ksdwk-970[wykua]",
                            "nwlddtqtpo-ojp-dezclrp-119[dplot]", "rgllk-qss-ymdwqfuzs-274[lzpkf]",
                            ...
                            "encuukhkgf-fag-ucngu-440[ugcfk]", "cvabijtm-moo-twoqabqka-980[aobmq]",
