...
import com.scavi.brainsqueeze.adventofcode.y2016.Day7InternetProtocolVersion;
import org.junit.Assert;
import org.junit.Test;

import static com.scavi.brainsqueeze.adventofcode.y2016.Day7InternetProtocolVersion.*;

/**
 * @author Michael Heymel
 * @since 07/12/16
 */
public class Day7InternetProtocolVersionTest {
    @Test
    public void testABBA1() {
        String[] inputAddress = new String[]{"abba[mnop]qrst"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new TransportLayerSnooping());
        int tlsSupported = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(1, tlsSupported);
    }


    @Test
    public void testABBA2() {
        String[] inputAddress = new String[]{"abcd[bddb]xyyx"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new TransportLayerSnooping());
        int tlsSupported = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(0, tlsSupported);
    }


    @Test
    public void testABBA3() {
        String[] inputAddress = new String[]{"aaaa[qwer]tyui"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new TransportLayerSnooping());
        int tlsSupported = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(0, tlsSupported);
    ...
    @Test
    public void testABBA4() {
        String[] inputAddress = new String[]{"ioxxoj[asdfgh]zxcvbn"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new TransportLayerSnooping());
        int tlsSupported = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(1, tlsSupported);
    ...
    @Test
    public void testABBA5() {
        String[] inputAddress = new String[]{"asdfasdf[asdfgh]ijoxxo"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new TransportLayerSnooping());
        int tlsSupported = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(1, tlsSupported);
    ...
    @Test
    public void testAbaBab1() {
        String[] inputAddress = new String[]{"aba[bab]xyz[aaaa]"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new SuperSecretListening());
        int superSecretListening = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(1, superSecretListening);
    }


    @Test
    public void testAbaBab2() {
        String[] inputAddress = new String[]{"xyx[xyx]xyx"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new SuperSecretListening());
        int superSecretListening = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(0, superSecretListening);
    }


    @Test
    public void testAbaBab3() {
        String[] inputAddress = new String[]{"aaa[kek]eke"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new SuperSecretListening());
        int superSecretListening = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(1, superSecretListening);
    ...
    @Test
    public void testAbaBab4() {
        String[] inputAddress = new String[]{"zazbz[bzb]cdb"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new SuperSecretListening());
        int superSecretListening = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(1, superSecretListening);
    ...
    @Test
    public void testAbaBab5() {
        String[] inputAddress = new String[]{"cdb[bzb]zazbz"};
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new SuperSecretListening());
        int superSecretListening = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(1, superSecretListening);
    ...
    public void testQuestion1() {
        String[] inputAddress = getInput();
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new TransportLayerSnooping());
        int tlsSupported = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(118, tlsSupported);
    }
    ...
    public void testQuestion2() {
        ...
        Day7InternetProtocolVersion internetProtocolVersion =
                new Day7InternetProtocolVersion(new SuperSecretListening());
        int tlsSupported = internetProtocolVersion.tlsIpSupportCount(inputAddress);
        Assert.assertEquals(260, tlsSupported);
    }


    private String[] getInput() {
        String[] inputAddresses = new String[]{
