...
import static com.scavi.brainsqueeze.adventofcode2016.Day1NoTimeForATaxicab.*;
import static com.scavi.brainsqueeze.adventofcode2016.Day1NoTimeForATaxicab.Direction.*;

/**
 * @author Michael Heymel
 * @since 01/12/16
 */
public class Day1NoTimeForATaxicapbTest {
    ...
    public void testValidation2() {
        Day1NoTimeForATaxicab noTaxiCab = new Day1NoTimeForATaxicab();
        int shortestDistance = noTaxiCab.shortestDistance(new Move(R, 2),
                new Move(R, 2),
                new Move(R, 2));
    ...
    public void test() {
        ...
        Move[] movementSequence = Move.from(
                "L5, R1, R4, L5, L4, R3, R1, L1, R4, R5, L1, L3, R4, L2, L4, R2, L4, L1, R3, R1, R1, " +
                        ...
                        "L3, R4, L1, L1, R1, R50, L1, R1, R76, R5, R4, R2, L5, L3, L5, R2, R1, L1, R2, L3, R4, R2, L1, L1, R4, L1, L1, R185, R1, L5, L4, L5, L3, R2, R3, R1, L5, R1, L3, L2, L2, R5, L1, L1, L3, R1, R4, L2, L1, L1, L3, L4, R5, L2, R3, R5, R1, L4, R5, L3, R3, R3, R1, R1, R5, R2, L2, R5, L5, L4, R4, R3, R5, R1, L3, R1, L2, L2, R3, R4, L1, R4, L1, R4, R3, L1, L4, L1, L5, L2, R2, L1, R1, L5, L3, R4, L1, R5, L5, L5, L1, L3, R1, R5, L2, L4, L5, L1, L1, L2, R5, R5, L4, R3, L2, L1, L3, L4, L5, L5, L2, R4, R3, L5, R4, R2, R1, L5");
        int shortestDistance = noTaxiCab.shortestDistance(movementSequence);
